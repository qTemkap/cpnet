...
namespace Cryptography_LB3
{
    public class TripleDesService
    {
        ...
        public static void DecryptTripleDES(byte[] encryptedFile, byte[] key, byte[] vector)
        {
            try
            {

                Console.WriteLine($"Encrypted data: {System.Text.Encoding.UTF8.GetString(encryptedFile)}");
                // Decrypt the bytes to a string.
                string decrypted = Decrypt(encryptedFile, key, vector);
